...
- **formats**: ["ndjson","json"]
- **ndjson**: {"item_kinds":["log","stdout","stderr","status","progress"],"log_record_schema":{"extra":"object (string-to-string pairs)","level":"string (TRACE|DEBUG|INFO|WARN|ERROR)","message":"string","source":"string (e.g., alfred::configuration::load)","timestamp":"string (RFC3339 UTC; seconds preferred; max milliseconds)"},"ordering":"Stable by emission order within the job.","rules":"Each line is a complete JSON object. Callers MUST tolerate chunking and resume using cursors/job offsets."}
