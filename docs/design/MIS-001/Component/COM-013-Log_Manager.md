# Component (Subsystem): COM-013 Log Manager

Tails and filters logs and exposes log-related tooling for debugging.
...
- executes [STM-011](../State_Machine/STM-011-Log_Manager_State_Machine.md)
